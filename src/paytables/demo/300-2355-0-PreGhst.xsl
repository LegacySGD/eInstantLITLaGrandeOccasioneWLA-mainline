			...
			<lxslt:component prefix="my-ext" functions="formatJson,retrievePrizeTable,getType">
				<lxslt:script lang="javascript">
					...
					function formatJson(jsonContext, translations, prizeTable, prizeValues, prizeNamesDesc)
					{
						...
						var scenarioBonusNum	 = scenario.split('|')[1];
						var scenarioYourNums     = scenario.split('|')[2].split(',');
						var scenarioJollyNums    = scenario.split('|')[3].split(',');
						var scenarioBonusGames   = scenario.split('|')[4].split(',');
						...
						var arrBonusGameParts = [];
						var arrBonusGames     = [];
						var arrJollyNumParts  = [];
						var arrJollyNums      = [];
						var arrWinNums  	  = [];
						var arrYourNumParts   = [];
						var arrYourNums 	  = [];
						...
						objBonusNum.sValue = scenarioBonusNum;

						for (var indexYourNum = 0; indexYourNum < scenarioYourNums.length; indexYourNum++)
						{
							objYourNum = {sValue: '', sPrize: '', bMatched: false};
							...
							for (indexWinNum = 0; indexWinNum < arrWinNums.length; indexWinNum++)
							{
								if (objYourNum.sValue == arrWinNums[indexWinNum].sValue)
								{
									objYourNum.bMatched = true;
									arrWinNums[indexWinNum].bMatched = true;
								}
							}

							if (objYourNum.sValue == objBonusNum.sValue)
							{
								objYourNum.bMatched = true;
						...
						for (var indexJollyNum = 0; indexJollyNum < scenarioJollyNums.length; indexJollyNum++)
						{
							objJollyNum = {sValue: '', sPrize: '', bMatched: false};

							arrJollyNumParts = scenarioJollyNums[indexJollyNum].split(':');

							objJollyNum.sValue = arrJollyNumParts[0];
							objJollyNum.sPrize = arrJollyNumParts[1];

							for (indexWinNum = 0; indexWinNum < arrWinNums.length; indexWinNum++)
							{
								if (objJollyNum.sValue == arrWinNums[indexWinNum].sValue)
								{
									objJollyNum.bMatched = true;
									arrWinNums[indexWinNum].bMatched = true;
								}
							}

							arrJollyNums.push(objJollyNum);
						}

						for (var indexBonusGame = 0; indexBonusGame < scenarioBonusGames.length; indexBonusGame++)
						{
							objBonusGame = {sValue: '', sPrize: '', bMatched: false};

							arrBonusGameParts = scenarioBonusGames[indexBonusGame].split(':');

							objBonusGame.sValue = arrBonusGameParts[0];
							objBonusGame.sPrize = arrBonusGameParts[1];

							if (objBonusGame.sValue == 'sacco')
							{
								objBonusGame.bMatched = true;
							}

							arrBonusGames.push(objBonusGame);
						}
						...
						textStr1    = getTranslationByName("titleBonusNum", translations);
						...
						canvasIdStr  = 'cvsBonusNumData';
						elementStr   = 'eleBonusNumData';
						boxColourStr = (objBonusNum.bMatched) ? colourLime : colourWhite;
						textStr1     = objBonusNum.sValue;
						...
						for (var indexYourNumRow = 0; indexYourNumRow < yourNumRows; indexYourNumRow++)
						{
							...
							for (var indexYourNumCol = 0; indexYourNumCol < yourNumsPerRow; indexYourNumCol++)
							{
								...
								boxColourStr = (arrYourNums[indexYourNum].bMatched) ? colourLime : colourWhite;
						...
						canvasIdStr = 'cvsJollyNumsTitle'; 
						elementStr  = 'eleJollyNumsTitle';
						textStr1    = getTranslationByName("titleJollyNums", translations);
						...
						for (var indexJollyNum = 0; indexJollyNum < scenarioJollyNums.length; indexJollyNum++)
						{
							...
							canvasIdStr  = 'cvsJollyNumData' + indexJollyNum.toString();
							elementStr   = 'eleJollyNumData' + indexJollyNum.toString();
							boxColourStr = (arrJollyNums[indexJollyNum].bMatched) ? colourLime : colourWhite;
							textStr1     = arrJollyNums[indexJollyNum].sValue;
							textStr2     = convertedPrizeValues[getPrizeNameIndex(prizeNames, arrJollyNums[indexJollyNum].sPrize)];
						...
						for (var indexBonusGame = 0; indexBonusGame < arrBonusGames.length; indexBonusGame++)
						{
							r.push('<td align="center">');

							canvasIdStr = 'cvsBonusGameTitle' + indexBonusGame.toString();
							elementStr  = 'eleBonusGameTitle' + indexBonusGame.toString();
							textStr1    = getTranslationByName("titleBonusGame", translations) + ' ' + (indexBonusGame + 1).toString();
						...
						for (var indexBonusGame = 0; indexBonusGame < arrBonusGames.length; indexBonusGame++)
						{
							...
							canvasIdStr  = 'cvsBonusGameData' + indexBonusGame.toString();
							elementStr   = 'eleBonusGameData' + indexBonusGame.toString();
							boxColourStr = (arrBonusGames[indexBonusGame].bMatched) ? colourLime : colourWhite;
							textStr1     = arrBonusGames[indexBonusGame].sValue;
							textStr2     = convertedPrizeValues[getPrizeNameIndex(prizeNames, arrBonusGames[indexBonusGame].sPrize)];

							showBox(canvasIdStr, elementStr, 2 * boxWidth, boxColourStr, colourBlack, textStr1, textStr2);
