...
public class LITLaGrandeOccasioneWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITLaGrandeOccasioneWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITLaGrandeOccasioneWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITLaGrandeOccasioneWLAIW/InitOutcome.xml").getDocumentElement();
